    ...
    <div className="flex h-screen bg-slate-100 dark:bg-slate-900 transition-colors duration-300">
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto overflow-x-hidden">
          <SidebarItem icon={<LayoutDashboard size={20} />} label="Dashboard" to="/" active={location.pathname === '/'} isOpen={isSidebarOpen} />
          <SidebarItem icon={<ShoppingBag size={20} />} label="Pedidos" to="/pedidos" active={location.pathname === '/pedidos'} isOpen={isSidebarOpen} />
        ...
        <div className="p-4 border-t border-slate-800 space-y-4">
          ...
          >
            ...
            {isSidebarOpen && <span className="font-medium animate-in fade-in duration-200">{isDarkMode ? 'Modo Claro' : 'Modo Escuro'}</span>}
          </button>
          ...
          >
            <LogOut size={20} />
            {isSidebarOpen && <span className="font-medium animate-in fade-in duration-200">Sair</span>}
          </button>
        </div>
      </aside>
