          ...
          <table className="w-full text-left">
            <thead className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-700">
              <tr>
                ...
                {canEdit && <th className="px-6 py-4 font-semibold text-slate-600 dark:text-slate-300 text-right">Ações</th>}
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
              ...
              {products.length === 0 && (
                <tr>
                  <td colSpan={canEdit ? "4" : "3"} className="px-6 py-12 text-center text-slate-400 dark:text-slate-500 italic">
